...
function App() {
  ...
  return (
    <div className="app">
      ...
      {showAlert && <div className="alert" style={{ backgroundColor: alertColor }}>Task "{lastTaskName}" {alertColor === '#28a745' ? 'completion status changed!' : alertColor === '#007bff' ? 'added successfully!' : 'deleted!'}</div>}
